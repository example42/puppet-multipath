...
describe 'multipath' do
  ...
  describe 'Test standard installation' do
    it { should contain_package('multipath').with_ensure('present') }
  ...
  describe 'Test installation of a specific version' do
    ...
    it { should contain_package('multipath').with_ensure('1.0.42') }
  end
  ...
  describe 'Test decommissioning - absent' do
    ...
    it 'should remove Package[multipath]' do should contain_package('multipath').with_ensure('absent') end
  ...
  describe 'Test noops mode' do
    ...
    it { should contain_package('multipath').with_noop('true') }
  ...
  describe 'Test params lookup' do
    ...
    let(:params) { { :port => '42' } }
    it 'should honour top scope global vars' do should contain_monitor__process('multipath_process').with_enable('true') end
  end

  describe 'Test params lookup' do
    let(:facts) { { :multipath_monitor => true , :ipaddress => '10.42.42.42' } }
    let(:params) { { :port => '42' } }
    it 'should honour module specific vars' do should contain_monitor__process('multipath_process').with_enable('true') end
  end

  describe 'Test params lookup' do
    let(:facts) { { :monitor => false , :multipath_monitor => true , :ipaddress => '10.42.42.42' } }
    let(:params) { { :port => '42' } }
    it 'should honour top scope module specific over global vars' do should contain_monitor__process('multipath_process').with_enable('true') end
  end

  describe 'Test params lookup' do
    let(:facts) { { :monitor => false , :ipaddress => '10.42.42.42' } }
    let(:params) { { :monitor => true , :firewall => true, :port => '42' } }
    it 'should honour passed params over global vars' do should contain_monitor__process('multipath_process').with_enable('true') end
  end
